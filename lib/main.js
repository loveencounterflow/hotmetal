...
(function() {
  ...
  this.fragmentize = function(text, settings) {
    var R, breakpoint, chrs, extended, incremental, last_position, line_breaker, matcher, part, position, required, shred, shreds, subpart, whitespace, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4;
    text = text.replace(/\n/g, ' ');
    last_position = null;
    incremental = (_ref = settings != null ? settings['incremental'] : void 0) != null ? _ref : true;
    chrs = (_ref1 = settings != null ? settings['chrs'] : void 0) != null ? _ref1 : false;
    extended = (_ref2 = settings != null ? settings['extended'] : void 0) != null ? _ref2 : false;
    if (extended) {
      throw new Error("setting `extended` not supported");
    }
    whitespace = (_ref3 = settings != null ? settings['whitespace'] : void 0) != null ? _ref3 : false;
    ...
    if (chrs) {
      ...
      R = (function() {
        ...
        _results = [];
        for (_i = 0, _len = shreds.length; _i < _len; _i++) {
          shred = shreds[_i];
          if (shred !== '') {
            _results.push(shred);
          }
  ...
  this.HTML.parse = (function(_this) {
    return function(html, settings) {
      ...
      var R, chrs, disperse, fragmentize, fragmentize_settings, handlers, hyphenate, hyphenation, parser, whitespace, _ref, _ref1, _ref2, _ref3;
      disperse = (_ref = settings != null ? settings['disperse'] : void 0) != null ? _ref : true;
      hyphenation = (_ref1 = settings != null ? settings['hyphenation'] : void 0) != null ? _ref1 : true;
      whitespace = (_ref2 = settings != null ? settings['whitespace'] : void 0) != null ? _ref2 : false;
      chrs = (_ref3 = settings != null ? settings['chrs'] : void 0) != null ? _ref3 : false;
      ...
      handlers = {
        ...
        text: function(text) {
          var text_part, _i, _len, _ref4, _results;
          text = CND.escape_html(text);
          text = hyphenate(text);
          _ref4 = fragmentize(text, fragmentize_settings);
          _results = [];
          for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
            text_part = _ref4[_i];
        ...
        startTag: function(name, a) {
          var attributes, k, v, _i, _len, _ref4;
          attributes = {};
          if (a != null) {
            for (_i = 0, _len = a.length; _i < _len; _i++) {
              _ref4 = a[_i], k = _ref4.name, v = _ref4.value;
              attributes[k] = v;
            }
          }
          if (__indexOf.call(_this.HTML._lone_tags, name) >= 0) {
            if (name === 'wbr') {
  ...
  this.HTML.split = (function(_this) {
    return function(html, settings) {
      ...
      var R, chrs, disperse, fragmentize, fragmentize_settings, handlers, hyphenate, hyphenation, last_type, parser, whitespace, _ref, _ref1, _ref2, _ref3;
      disperse = (_ref = settings != null ? settings['disperse'] : void 0) != null ? _ref : true;
      hyphenation = (_ref1 = settings != null ? settings['hyphenation'] : void 0) != null ? _ref1 : true;
      whitespace = (_ref2 = settings != null ? settings['whitespace'] : void 0) != null ? _ref2 : false;
      chrs = (_ref3 = settings != null ? settings['chrs'] : void 0) != null ? _ref3 : false;
