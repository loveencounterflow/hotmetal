...
(function() {
  ...
  this.break_lines = function(html, test_line, set_line, handler) {
    ...
    return this.parse(html, (function(_this) {
      return function(error, hotml) {
        var is_first, is_last, last_slice, lines, slice, start, stop;
        if (error != null) {
        ...
        while (true) {
          stop += 1;
          is_last = (stop > hotml.length) || (stop - start === 0 && stop === hotml.length);
          if (is_last) {
            if (last_slice != null) {
              if (set_line != null) {
                set_line(last_slice, is_first, is_last);
              }
              lines.push(last_slice);
            } else if (slice != null) {
              if (set_line != null) {
                set_line(slice, is_first, is_last);
              }
              lines.push(slice);
            }
            return handler(null, lines);
          }
          slice = _this.as_html(_this.slice(hotml, start, stop));
          if (!test_line(slice, is_first, is_last)) {
            if (last_slice != null) {
              if (set_line != null) {
                set_line(last_slice, is_first, is_last);
              }
