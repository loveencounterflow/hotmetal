          ...
          switch (type) {
            ...
            case 'end':
              ...
              for (stop = _i = 5; _i <= 9; stop = ++_i) {
                urge(start, stop, _this.rpr(_this.slice(collector, start, stop)));
                info(start, stop, _this.as_html(_this.slice(collector, start, stop)));
              }
              help(_this.rpr(collector));
              info(_this.as_html(collector));
              null;
              break;
            default:
